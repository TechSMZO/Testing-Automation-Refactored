...
public class LoginTest {
    ...
    public void loginDemoTest() {
        ...
        try {
            ...
            wait.until(ExpectedConditions.or(
                    ...
                    ExpectedConditions
                            .visibilityOfElementLocated(By.xpath("//div[contains(text(),'Invalid credentials')]")),
                    ExpectedConditions.visibilityOfElementLocated(
                            By.xpath("//div[contains(text(),'Email or phone is not registered."
                                    + "')]"))));

            // Validating the test case is pass or failed after checking login was
            // successful or not
            ...
            if (currentUrl.contains("/orders/new") && title.contains("Shipmozo")) {
                ...
                long endTime = System.currentTimeMillis(); // Calculating the dashboard loading time after clicking on
                                                           // login button
    ...
    public void AssignCourier() {
        ...
        try {
            ...
            // WebElement assignCourierButton =
            // wait.until(ExpectedConditions.elementToBeClickable(By.xpath(
            // "//p[contains(text(),'Ref. ID:
            // 123')]/ancestor::tr/following-sibling::tr[1]//button[contains(., 'Assign
            // Courier')]"
            // )));
            ...
            test.fail("Test failed due to: " + e.getMessage())
                    .addScreenCaptureFromPath(
                            ExtentManager.captureScreenshot(driver, "CourierAssign_Failed_" + browser));
